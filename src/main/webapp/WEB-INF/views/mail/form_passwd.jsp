...
<form name='mailForm' method='post' action="./send_passwd.do">
  <table class='table_basic'>
    ...
    <tr>
      ...
      <td class='td_left'><input type="email" name="id" value='' class='input_basic' style='width: 50%;'></td>
    </tr>
    <tr>
...
<div  class="bottom_menu">
  <input type="submit" class="btn btn-secondary btn-sm" value="보내기">
  <input type="button" class="btn btn-secondary btn-sm" value="취소" onclick="history.back()">
</div>
</form>
</div>
